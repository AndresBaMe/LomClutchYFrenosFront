...
export default function LoginForm(){
    ...
    <p className="text-lg text-gray-600 mt-2 mb-5">
      Precisión mecánica,<br />
      confianza en cada vuelta
    </p>
  </div>
            <Input type="email" placeholder="User"/>
            <Input type="password" placeholder="Password"/>
            <Link href="/Home/work-order">
            <button type="submit" className="h-10 w-30 bg-white rounded-md text-black  mt-10 hover:bg-gray-200 cursor-pointer">Submit</button>
            </Link>
        </div>
    );
}